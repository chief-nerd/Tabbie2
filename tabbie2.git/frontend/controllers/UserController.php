...
class UserController extends BaseuserController
{
                    ...
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            ...
                            if (isset($_GET["tournament_id"])) {
                                ...
                                if ($t->isTabMaster(Yii::$app->user->id) || $t->isConvenor(Yii::$app->user->id))
                                    return true;
                            }
                            return false;
                        }
     ...
     * @return mixed
     */
    public function actionView($id, $tournament_id = null)
    {
        ...
        if ($tournament && ($tournament->isTabMaster($this->id) || $tournament->isConvenor($this->id))) {
            $custom_attributes = ArrayHelper::map($model->getCustomValues($tournament->id), "name", "value");
        }
