        ...
        <? if ($model->status >= \common\models\Tournament::STATUS_CLOSED) {
            $items = [
                    ...
                    [
                        ...
                        'linkOptions' => ['data-url' => \yii\helpers\Url::to(['stats/team-tabx', "tournament_id" => $model->id])],
                            'options'     => ['id' => 'team-tab'],
                    ],
                    [
                            'label'       => Yii::t("app", "Speaker Tab"),
                        'linkOptions' => ['data-url' => \yii\helpers\Url::to(['stats/speaker-tabx', "tournament_id" => $model->id])],
